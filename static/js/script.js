...
const generateBotResponse = async (incomingMessageDiv) => {
  ...
  try {
    // Fetch bot response from local API
    ...
    // Convert markdown-style bold and newlines to HTML for display
    let formattedText = apiResponseText.replace(/\*\*(.*?)\*\*/g, '<strong>$1</strong>');
